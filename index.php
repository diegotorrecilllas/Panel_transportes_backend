                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/html/ltr/pedidos.html">Pedido</a>
                                <a class="dropdown-item" href="#">Albarán</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/html/ltr/facturas.html">Factura</a>
                            </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- Search -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h4 class="card-title">Estadística de envíos</h4>
                                        <h5 class="card-subtitle">Envíos anuales</h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <!-- column -->
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Clientes Totales</small>
                                                </div>
                                            </div>
                                             <div class="col-6">
                                                <div class="bg-dark p-10 text-white text-center">
                                            ...
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   <i class="fa fa-eur-plus m-b-5 font-16"></i>
                                                   <h5 class="m-b-0 m-t-5">656</h5>
                                                   <small class="font-light">Total Facturación</small>
                                                </div>
                                            </div>
                                             <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Total Pedidos</small>
                                                </div>
                                            </div>
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Entregas Pendientes</small>
                                                </div>
                                            </div>
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Paquetes entregados</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
